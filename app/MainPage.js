...
class MainPage extends Component {
  ...
  constructor(props) {
    ...
    this.difference = 0;
    this.state = {
      todayPersian1: '___', todayPersian2: '___', todayPersian3: '___', todayGeorgian: '___', todayHijri: '___', sampleData: [], visible: false
    };
    this.result = [{people: []}];
    ...
    return (<ImageBackground
      ...
      <View
        ...
        <View
          ...
          <Text
            style={{
              fontSize: 13, color: '#FFFFFF', width: '100%', textAlign: 'center', paddingEnd: 30, paddingStart: 0, marginTop: 35
            }}>
        ...
        <View
          ...
          <Text
            style={{
              fontFamily: 'byekan', fontSize: 13, color: '#FFFFFF', width: '100%', textAlign: 'center', paddingEnd: 0, paddingStart: 30, marginTop: 15
            }}>
      ...
      <View
        style={{
          flex: 10, backgroundColor: '#FFFFFF', marginHorizontal: 20, borderRadius: 20, marginBottom: 30, paddingTop: 15,
        }}>
        <View
          style={{
      ...
      <View
        style={{
          position: 'absolute', left: 0, right: 0, bottom: 10, height: 50, alignItems: 'center',
        }}
      >
        <TouchableWithoutFeedback
        ...
        >
          <View
            style={{
              width: 60, height: 60, borderRadius: 30, backgroundColor: '#7C7AF2', alignItems: 'center', justifyContent: 'center'
            }}
          >
            <Image
              style={{
                width: 50, height: 50, borderRadius: 25, tintColor: '#FFFFFF', backgroundColor: '#7C7AF2', borderWidth: 2, borderColor: '#FFFFFF'
              }}
      ...
      <View
        ...
        <View style={{flex: 1, justifyContent: 'center'}}>
          <Text
            style={{
              fontFamily: 'byekan', fontSize: 13, color: '#FFFFFF', width: '100%', textAlign: 'center', paddingEnd: 10, paddingStart: 10
            }}>
  ...
  sessionDetilItem() {
    return (<View>
      ...
      >
        <View
          style={{
            flexDirection: 'row', width: '100%', alignItems: 'center', justifyContent: 'flex-end', borderRadius: 10, paddingTop: 5, paddingBottom: 5,
          }}>
          <Text
            style={{
          ...
          <View
            style={{
              width: 50, height: 50, borderRadius: 25, overflow: 'hidden', borderWidth: 2, borderColor: '#00b', margin: 10,
            }}
          >
            <Image
              style={{

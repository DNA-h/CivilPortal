      ...
      >
        ...
        <View
          ...
          <View
            ...
            <View style={{flex: 1}}/>
            {
              this.renderCarousel(dailyHour, (index) => {
                this._endHour = index;
              })
            }
            <Text style={{marginHorizontal: 10, color: '#FFFFFF'}}>:</Text>
            {
              this.renderCarousel(dailyMinutes, (index) => {
        ...
        <Modal
          ...
          onBackButtonPress={() => this.setState({selectPlace: false})}
        ...
        <Modal
          ...
          onBackButtonPress={() => this.setState({createNewVisible: false})}
